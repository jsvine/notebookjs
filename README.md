...
Notebook.js currently doesn't support all of MathJax's syntaxes (MathML, AsciiMath, LaTeX). It does however support a significant subset of LaTeX via [KaTeX](https://github.com/Khan/KaTeX).
